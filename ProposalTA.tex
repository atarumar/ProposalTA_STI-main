...
\begin{center}
    ...
    {\Large\bfseries Pengembangan \textit{Legislative Activity Tracker} DPR RI menggunakan \textit{Information Extraction} (\textit{NER} dan \textit{Entity Linking}) Multi-Sumber }\\
     \vspace{4cm}
...
\input{Lampiran_FR.tex}

\input{Lampiran_solusi.tex}

\input{Lampiran_ahp.tex}
